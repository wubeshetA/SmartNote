...
// in smartnote/test/views/note/notes_list_test.dart.
...
import 'package:smartnote/backend/storage/cloud/cloud_database.dart' as _i4;
...
/// A class which mocks [SupabaseDatabaseHelper].
///
/// See the documentation for Mockito's code generation for more information.
class MockSupabaseDatabaseHelper extends _i1.Mock
    implements _i4.SupabaseDatabaseHelper {
  MockSupabaseDatabaseHelper() {
  ...
  @override
  _i5.Future<int> insertPath(Map<String, dynamic>? path) => (super.noSuchMethod(
        Invocation.method(
          #insertPath,
          [path],
        ),
  ...
  @override
  _i5.Future<List<dynamic>> getPaths() => (super.noSuchMethod(
        Invocation.method(
          #getPaths,
          [],
        ),
